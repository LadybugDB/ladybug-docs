---
title: PostgreSQL Extension (pg_ladybug)
description: Run Cypher queries inside PostgreSQL with the pg_ladybug extension.
---
...
:::note[Note]
This page covers `pg_ladybug`, which runs Cypher *inside* PostgreSQL. To query a
PostgreSQL database from a standalone Ladybug instance instead, see the
[`postgres` extension](/extensions/attach/postgres).
:::

Source: [LadybugDB/pg_ladybug](https://github.com/LadybugDB/pg_ladybug).
