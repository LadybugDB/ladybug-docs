...
3. Enter the URL of the ladybug-swift repository: `https://github.com/LadybugDB/swift-ladybug`.
...
- Java: The latest snapshot version is available on [GitHub Packages](https://github.com/LadybugDB/ladybug/packages/)
