---
title: "LLM extension"
description: "Access popular LLM APIs to create embeddings directly within Ladybug using Cypher"
---

import { Tabs, TabItem } from '@astrojs/starlight/components';

The `llm` extension helps you run LLM-based workflows directly within Ladybug using Cypher.
...
:::note[Note]
We plan to add more functions to this extension in the future, such as sending queries to LLMs directly from Ladybug.
:::
...
directly in Ladybug. Refer to the [vector search docs](/extensions/vector) for an example.
