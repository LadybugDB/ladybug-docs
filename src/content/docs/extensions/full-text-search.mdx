...
Currently, Ladybug supports creating FTS indexes on only node tables' `STRING` properties.
...
to show all the available indexes in Ladybug, including FTS indexes.
