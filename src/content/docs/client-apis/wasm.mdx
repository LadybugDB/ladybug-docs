...
description: "Run Ladybug graph database in web browsers using WebAssembly for client-side graph processing"
---
...
of devices. This page describes Ladybug's Wasm API, enabling Ladybug databases to run inside Wasm-capable
browsers.

## Benefits of WASM

Several benefits of Ladybug-Wasm are the following:
...
The example can be found in [the examples directory](https://github.com/LadybugDB/lbug/tree/master/tools/wasm/examples).
...
This section is relevant if you are interested in contributing to Ladybug's Wasm API.
