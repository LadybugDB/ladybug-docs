...
ExternalProject_Add(lbug-prebuilt
    URL https://github.com/LadybugDB/lbug/releases/download/v${version}/liblbug-linux-x86_64.tar.gz
)
...
FetchContent_Declare(lbug
    URL https://github.com/LadybugDB/lbug/archive/refs/tags/v0.5.0.zip
