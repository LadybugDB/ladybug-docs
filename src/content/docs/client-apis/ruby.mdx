...
RubyGems page for `ruby-lbug`.

Please contact the maintainer or post an issue on the project's
[GitHub repository](https://github.com/ged/ruby-lbug) if you have any issues using this API.

<LinkCard
  title="Ruby API documentation"
  href="https://rubygems.org/gems/ruby-lbug"
/>